...
### narrative 
Since the localStorage will be used for the sign-ups, we will implement a log-out feature (removing data) and a change password / username feature (updating data). 
